        ...
        <div class="card">
            <div class="card-header bg-light">
                <h3 class="card-title text-indigo">
                    ...
                    Edit Kanal Pembayaran
                </h3>
                <div class="card-tools">
                    <ul class="pagination pagination-sm">
                        <li class="page-item">
                            <a href="{{ route('web.public.kanal-pembayaran') }}" class="page-link bg-indigo">
            ...
            <form action="{{ route('web.public.kanal-pembayaran.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input name="nama_kanal" type="text" id="nama_kanal" class="form-control @error('nama_kanal') is-invalid @enderror" value="{{ old('nama_kanal') ? old('nama_kanal') : $data->nama_kanal }}">
                                    @error('nama_kanal')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea name="uraian_kanal" id="uraian_kanal" class="form-control @error('uraian_kanal') is-invalid @enderror">{{ old('uraian_kanal') ? old('uraian_kanal') : $data->uraian_kanal }}</textarea>
                                    @error('uraian_kanal')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <img id="preview_img" src="../../../images/{{ $data->berkas_kanal }}" class="img-thumbnail mb-2" width="100" />
