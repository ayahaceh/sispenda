                ...
                <div class="row">
                    <div class="col-md-3">
                        <h3 class="card-title text-indigo">
                            <i class="fas fa-user-friends mr-2"></i>Data Profil Wajib Pajak (Baru)</a>
                        </h3>
                    </div>
                    <div class="col-md-9 mt-2 mt-md-0">
                        <div class="d-md-flex justify-content-end">
                            <div class="mr-2">
                                <form action="{{ route('profil.user.baru') }}" method="GET">
                    ...
                    <tbody class="text-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br />
                                @endisset
                                @isset($profil->joinProv->nama_prov)
                                Prov. {{ $profil->joinProv->nama_prov }}
                                @endisset
                            </td>
                            <td>
                                <a href="{{ route('profil.user.verifikasi', $profil->id) }}" class="btn btn-sm bg-indigo">
