                ...
                <div class="row">
                    <div class="col-md-3">
                        <h3 class="card-title text-indigo">
                            <i class="fas fa-user-friends mr-2"></i>Data Profil Wajib Pajak<small class="badge bg-success">(Valid)</small>
                        </h3>
                    </div>
                    <div class="col-md-9 mt-2 mt-md-0">
                        <div class="d-md-flex justify-content-end">
                            <div class="mr-2">
                                <form action="{{ route('ppat.profil.user.valid') }}" method="GET">
                            ...
                            <div class="btn-group mt-2 mt-md-0" role="group" aria-label="Basic example">
                                <a href="{{ route('ppat.profil.user.export') }}" class="btn btn-sm bg-indigo">
                ...
                <table class="table table-hover table-sm">
                    ...
                    <tbody class="text-dark">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('ppat.profil.user.lihat.valid', $profil->id) }}" class="text-indigo">
                                    {{ $profil->nama }}
                                </a>
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('ppat.profil.user.lihat.valid', $profil->id) }}" class="text-dark">
                                    <small class="badge badge-{{$warna}}">{{ $profil->status_profil }}</small>
                                </a>
                            </td>
                            <td>
                                <a href="{{ route('ppat.profil.user.lihat.valid', $profil->id) }}">
