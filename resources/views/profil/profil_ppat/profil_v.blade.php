        ...
        <div class="card card-outline card-default">
            <div class="card-header bg-light">
                <h3 class="card-title text-indigo">
                    ...
                    Lihat Profil Wajib Pajak <small class="badge bg-danger">(Belum di approve)</small>
                </h3>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card-header bg-light">
                            <h6 class="text-indigo">
                                ...
                                <span class="badge bg-indigo float-right">
                                    <a href="{{ route('ppat.profil.user.edit', $data->id) }}" class="text-dark" data-toggle="modal" data-target="#tempatTinggal">
                                        <i class="fas fa-edit mr-1"></i> Edit
                                    </a>
                                </span>
                            </h6>
                    ...
                    <div class="col-md-6">
                        <div class="card-header bg-light disabled">
                            <h6 class="text-indigo">
                                ...
                                Kontak Wajib Pajak
                                <span class="badge bg-indigo float-right">
                                    <a href="{{ route('ppat.profil.user.edit', $data->id) }}" class="text-dark" data-toggle="modal" data-target="#kontak">
                                        <i class="fas fa-edit mr-1"></i> Edit
                                    </a>
                                </span>
                            </h6>
                        ...
                        <div class="card">
                            <div class="card-header bg-light">
                                <h6 class="text-indigo">
                                    ...
                                    Berkas Identitas
                                    <span class="badge bg-indigo float-right">
                                        <a href="{{ route('ppat.profil.user.edit', $data->id) }}" class="text-dark" data-toggle="modal" data-target="#berkasIdentitas">
                                            <i class="fas fa-edit mr-1"></i> Edit
                                        </a>
                                    </span>
                                </h6>
