    ...
    <div class="col-md-12">
        <div class="card card-outline card-default">
            <div class="card-header bg-light">
                <h3 class="card-title text-indigo"><i class="fas fa-chalkboard-teacher mr-2"></i> Tambah Profil Baru</h3>
            ...
            <form action="{{ route('ppat.profil.user.simpan') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <p class="text-muted">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-header bg-light p-2">
                                    <h6 class="text-indigo"><i class="fas fa-cloud-upload-alt mr-2"></i> Unggah Berkas</h6>
                                </div>
