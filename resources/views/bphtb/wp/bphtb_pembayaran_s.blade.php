    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <div class="card-footer d-print-none">
                <button type="button" class="btn bg-indigo " data-toggle="modal" data-target="#modalUploadButkiBayar">
...
<div class="modal fade" id="modalUploadButkiBayar" tabindex="-1" aria-labelledby="modalUploadButkiBayarLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <form id="form-upload" action="{{ route('wp.bphtb.pembayaran.store', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="custom-file">
                                <input type="file" name="berkas_bukti_pembayaran" class="custom-file-input @error('berkas_bukti_pembayaran') is-invalid @enderror" id="berkas_bukti_pembayaran" onchange="loadPreviewGambar(this);" class="form-control">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modalUploadButkiBayar">
                        Batal
                    </button>
