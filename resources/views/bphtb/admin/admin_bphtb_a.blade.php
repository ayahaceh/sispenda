        ...
        <div class="col-12">
            <div class="card card-default card-outline">
                <div class="text-indigo">
                    <form action="{{ route('bphtb.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    height="160" />
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <label for="nik_mask" class="col-md-3">NIK (KTP)</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="letak_nop" type="text" id="letak_nop"
                                                ...
                                                placeholder="Jl. Melati" required value="{{ old('letak_nop') }}">
                                            @error('letak_nop')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input name="luas_tanah" type="text" id="luas_tanah"
                                                    ...
                                                    maxlength="12" onchange="UpdateNjopPbb()" required
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input name="njop_pbb" type="text" id="njop_pbb"
                                                    class="form-control integer" placeholder="Otomatis" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="hak_nilai_pasar" class="col-sm-4 col-form-label">
                                            Hak Transaksi
                                            <small>(Nilai Pasar)</small>
                                        </label>
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="npopkp" type="text" id="npopkp" class="form-control integer"
                                                value="" placeholder="NPOPKP" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input name="jumlah" type="text" id="jumlah" class="form-control integer"
                                                value="" placeholder="Jumlah Terutang" readonly>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input name="tgl_b" type="date" id="tgl_b"
                                                            ...
                                                            value="{{ old('tgl_b') ? old('tgl_b') : date('Y-m-d') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-5">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group row">
                                                ...
                                                <input name="jumlah_setor" type="text" id="jumlah_setor"
                                                    ...
                                                    value="{{ old('jumlah_setor') }}" placeholder="Otomatis" required>
                                            </div>
                                            @error('jumlah_setor')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                ...
                                                <select name="no_rekening_bank" id="no_rekening_bank"
                                                    ...
                                                    @foreach ($ref_rekening as $item)
                                                        <option value="{{ $item->no_rekening }}"
                                                            {{ old('no_rekening_bank') == $item->no_rekening ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-group">
                                                <input name="tgl_setor" type="date" id="tgl_setor"
                                                    ...
                                                    value="{{ old('tgl_setor') ? old('tgl_setor') : date('Y-m-d') }}"
                                                    required onchange="kalkulasiBphtb()">
                                                @error('tgl_setor')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input name="tgl_bphtb" type="date" id="tgl_bphtb"
                                                class="form-control @error('tgl_bphtb') is-invalid @enderror"
                                                value="{{ old('tgl_bphtb') ? old('tgl_bphtb') : date('Y-m-d') }}"
                                                onchange="kalkulasiBphtb()" required>
                                            @error('tgl_bphtb')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                    ...
                                    <div class="form-group row">
                                        <label for="status_pembayaran" class="col-form-label col-md-4">Status
                                            Pembayaran</label>
                                        <div class="col-md-8">
                                            <select name="status_pembayaran" id="status_pembayaran"
                                                class="form-control @error('status_pembayaran') is-invalid @enderror"
                                                aria-placeholder="Status Pembayaran" required>
                                                <option
                                                    {{ old('status_pembayaran') == STATUS_PEMBAYARAN_BELUM_BAYAR ? 'selectedd' : '' }}>
                                                    {{ STATUS_PEMBAYARAN_BELUM_BAYAR }}
                                                </option>
                                                {{-- <option
                                                    {{ old('status_pembayaran') == STATUS_PEMBAYARAN_SEDANG_VERIFIKASI ? 'selectedd' : '' }}>
                                                    {{ STATUS_PEMBAYARAN_SEDANG_VERIFIKASI }}
                                                </option> --}}
                                                <option
                                                    {{ old('status_pembayaran') == STATUS_PEMBAYARAN_LUNAS ? 'selectedd' : '' }}>
                                            ...
                                            <select name="diterima_id" id="diterima_id"
                                                ...
                                                @foreach ($penandatangan_diterima as $diterima)
                                                    <option value="{{ $diterima->id }}"
                                                        {{ old('diterima_id') == $diterima->id ? 'selected' : '' }}>
                                            ...
                                            <select name="diverifikasi_id" id="diverifikasi_id"
                                                ...
                                                @foreach ($penandatangan_diverifikasi as $diverifikasi)
                                                    <option value="{{ $diverifikasi->id }}"
                                                        {{ old('diverifikasi_id') == $diverifikasi->id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <input name="tgl_diverifikasi" type="date" id="tgl_diverifikasi"
                                                ...
                                                value="{{ old('tgl_diverifikasi') ? old('tgl_diverifikasi') : date('Y-m-d') }}">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-end">
                                ...
                                <a href="{{ route('bphtb') }}" class="btn btn-warning px-md-5">
...
@section('script')
    ...
    @if (old('luas_tanah') || old('luas_bangunan') || old('njop_tanah') || old('njop_bangunan'))
        <script>
            UpdateNjopPbb();
        </script>
    @endif
