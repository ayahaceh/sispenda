...
<section class="invoice p-3 mb-3 bg-light">
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="button" class="btn btn-danger btn-lg float-right" data-toggle="modal" data-target="#modal-batal">
                <i class="fas fa-exclamation-triangle mr-1"></i> Batalkan BPHTB Ini
            </button>
        </div>
    </div>
    <!-- Modal Konfirmasi -->
            ...
            <div class="modal-content">
                <div class="modal-header bg-danger">
                    <h5 class="modal-title">
                        <i class="fas fa-exclamation-triangle mr-1"></i> Konfirmasi Pembatalan BPHTB
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('bphtb.pembatalan.update',$data->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-sm-6 col-form-label text-right">
                                Masukkan Password
                            </label>
                            <div class="col-sm-6">
                                <input type="password" class="form-control" name="current_password" id="current_password" value="{{old('current_password')}}" placeholder="Password Login anda!" required>
                                @error('password')
                                <div class="invalid-feedback">
                                    $message
                                </div>
                        ...
                        <input type="hidden" class="form-control" name="id_bphtb" id="id_bphtb" value="{{$data->id}}">
