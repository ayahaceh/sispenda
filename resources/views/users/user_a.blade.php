                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="email" type="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Email ...">
                                                @error('email')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="username" maxlength="25" type="text" id="username" class="form-control @error('username') is-invalid @enderror" value="{{ old('username') }}" placeholder="Username ...">
                                                @error('username')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input name="password" type="password" id="password" class="form-control" value="garuda" placeholder="Password ..." disabled>
                                                @error('password')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label for="user_group" class="col-sm-4 col-form-label">Role</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            <label for="foto" class="col-sm-4">Pilih Foto </label>
                                            <div class="col-sm-8">
                            ...
                            <div class="row">
                                <div class="form-group row">
                                    <div class="col-sm-4">
                                        <img id="preview_img" src="{{ asset('/upload/users/comp/default.jpg') }}" style="margin-bottom: 15px" class="" width="120" height="120" />
                                    </div>
                                    <div class="col-sm-8">
                                        <h5 class="text-indigo"><i class="icon fas fa-info text-indigo"></i> Informasi!</h5>
                                        <p class="text-secondary text-justify">
                                            Secara default, password pengguna/user Internal BPKK adalah
                                            <strong>"rahasia"</strong> (tanpa tanda petik),
                                            sedangkan password untuk pengguna/user Eksternal
                                            (Wajib Pajak, PPAT, BPN, dst) adalah <strong>"garuda"</strong>
                                            (tanpa tanda petik)
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="alert alert-success alert-dismissible">
                                ...
                                <small>
                                    Butuh Petunjuk dalam melakukan Penambahan Pengguna?
                                    Silahkan silahkan buka buku panduan untuk Admin!
                                    <a href="#" class="text-warning" target="_blank">
                                        <i> Download disini! </i>
                                    </a>
                                    <br />Secara default, password pengguna/user Internal BPKK adalah <strong>"rahasia"</strong> (tanpa tanda petik),
                                    sedangkan password untuk pengguna/user Eksternal (Wajib Pajak, PPAT, BPN, dst) adalah <strong>"garuda"</strong> (tanpa tanda petik)
                                </small>
                            </div>
                            --}}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row text-indigo">
                                <label for="nama" maxlength="30" class="col-sm-4 col-form-label">Nama Lengkap</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row text-indigo">
                                <label for="nik" class="col-sm-4 col-form-label">NIK <small>(NIK KTP)</small></label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row text-indigo">
                                <label for="tg" class="col-sm-4 col-form-label">Telegram</label>
                                <div class="col-sm-8">
