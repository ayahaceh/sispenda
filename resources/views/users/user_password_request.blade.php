    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary">
                <h3 class="card-title"><i class="fas fa-user mr-2"></i> Request Change Password</h3>
            </div><!-- /.card-header -->
                        ...
                        <div class="col-md-6">
                            <div class="form-group row text-primary">
                                <p class="col-sm-9">
                                    ...
                                    <br /> Link untuk melakukan <strong>ganti password</strong> akan dikirim ke email
                                    yang telah terdaftar tersebut.
                                    <br />Silahkan periksa email masuk,
                                    cek juga folder SPAM email anda jika tidak ditemukan email masuk
                                    dalam kotak masuk.
                                </p>
                            </div>
                        </div>
