...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-default">
            <form action="{{ route('nop.pbb.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input name="nama" id="nama" type="text" class="form-control" value="@isset($data->joinProfil->nama){{ $data->joinProfil->nama }}@endisset" disabled>
                            </div>
                            <div class="form-group">
                                <label>NIK (KTP)</label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <input name="alamat_profil" id="alamat_profil" type="text" class="col-sm-9 form-control" value="@isset($data->joinProfil->alamat){{ $data->joinProfil->alamat }}@endisset" disabled>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Desa</label>
                                <input name="desa_profil" id="desa_profil" type="text" class="col-sm-9 form-control" value="@isset($data->joinProfil->nama_desa){{ $data->joinDesa->nama_desa }}@endisset" disabled>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Kecamatan</label>
                                <input name="kec_profil" id="kec_profil" type="text" class="col-sm-9 form-control" value="@isset($data->joinProfil->nama_kec){{ $data->joinKec->nama_kec }}@endisset" disabled>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3">Jumlah NOP</label>
                                <input name="jumlah_nop" id="jumlah_nop" type="text" class="col-sm-9 form-control" value="@isset($data->joinProfil->jumlahNop){{ $data->joinProfil->jumlahNop->count() }}@endisset" disabled>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input name="hak_nilai_pasar" type="text" id="hak_nilai_pasar" value="{{ $data->hak_nilai_pasar }}" class="form-control integer @error('hak_nilai_pasar') is-invalid @enderror" placeholder="Hak Transaksi / Nilai Pasar" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var data2 = {
            id: '@isset($data->joinProfil->nik){{ $data->joinProfil->nik }}@endisset',
            text: '@isset($data->joinProfil->nama){{ $data->joinProfil->nama }}@endisset'
        };
