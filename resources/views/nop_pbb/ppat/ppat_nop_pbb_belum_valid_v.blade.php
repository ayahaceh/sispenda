        ...
        <div class="card card-outline card-default">
            <div class="card-header bg-indigo">
                <div class="d-flex justify-content-between">
                    <h6><i class="fas fa-user-alt mr-2"></i>Profil Wajib Pajak <small class="badge bg-danger">(Belum di approve)</small>
                    </h6>
                    <div class="row">
                        <a href="{{ url()->previous() }}" class="btn btn-default btn-sm text-indigo ml-2">
                            <i class="fas fa-angle-double-left text-indigo mr-2"></i>
                            Kembali
                        </a>
                        <a href="{{ route('nop.pbb.edit', $data->id) }}" class="btn btn-default btn-sm text-warning ml-2 editFunction">
                        ...
                        <form action="{{ route('nop.pbb.hapus', $data->id) }}" method="post">
                            @method('DELETE')
                            @csrf
                            <button class="btn btn-default btn-sm text-danger ml-2 deleteFunction">
