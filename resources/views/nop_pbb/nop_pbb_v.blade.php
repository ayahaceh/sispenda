        ...
        <div class="card card-outline card-default">
            <div class="card-header bg-indigo">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="row">
                        <a href="{{ url()->previous() }}" class="page-link text-indigo ml-2">
                            <i class="fas fa-angle-double-left text-indigo mr-2"></i>
                            Kembali
                        </a>
                        <a href="{{ route('nop.pbb.edit', $data->id) }}" class="page-link text-indigo ml-2 editFunction">
                            <i class="fas fa-edit text-indigo mr-2"></i>
                            Edit
                        </a>
                        <!-- hapus  -->
                        <form action="{{ route('nop.pbb.hapus', $data->id) }}" method="post">
                            @method('DELETE')
                            @csrf
                            <button class="page-link text-indigo ml-2 deleteFunction">
                                <i class="fas fa-trash text-indigo mr-2"></i> Hapus
                            </button>
                        </form>
