    ...
    <div class="row invoice-info">
        <div class="col-sm-5 invoice-col">
            ...
            <address>
                ...
                Desa
                @isset($data->joinProfilKepada->joinDesa->nama_desa){{ $data->joinProfilKepada->joinDesa->nama_desa }}@endisset<br>
                Kec.
                @isset($data->joinProfilKepada->joinKec->nama_kec){{ $data->joinProfilKepada->joinKec->nama_kec }}@endisset<br>
        ...
        <div class="col-sm-5 invoice-col">
            ...
            <address>
                ...
                Desa
                @isset($data->joinNop->joinDesa->nama_desa){{ $data->joinNop->joinDesa->nama_desa }}@endisset<br>
...
<div class="modal fade" id="modal-upload">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('wp.pengajuan-bphtb.upload', $data->id) }}" class="form-horizontal" method="POST" enctype="multipart/form-data">
                @csrf
