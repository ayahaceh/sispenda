...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-default">
            <form action="{{ route('transaksi.peralihan.update',['id' => $id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-header bg-indigo">
                    ...
                    <div class="card-tools">
                        <ul class="pagination pagination-sm">
                            ...
                            <li class="page-item">
                                <a href="javascript:void(0)" class="page-link text-indigo" onclick="modeEdit()">
                            ...
                            <li class="page-item">
                                ...
                                @if ($is_deleted > 0)
                                <a href="javascript:void(0)" class="page-link text-indigo" onclick="restore()">
                                ...
                                @if ($is_deleted == 0)
                                <a href="javascript:void(0)" class="page-link text-indigo" onclick="hapus()">
                            ...
                            <li class="page-item">
                                <a href="{{ route('transaksi.peralihan.laporan',['id' => $id]) }}" target="_blank" class="page-link text-indigo cetak">
                ...
                <div class="card-header bg-light">
                    <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <select id="profil_id" name="profil_id" onchange="UpdateProfil()" class="form-control" required> </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="nik_profil">NIK (KTP)</label>
                                        <input name="nik_profil" id="nik_profil" type="text" class="form-control" value="" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="alamat_profil">Alamat</label>
                                        <input name="alamat_profil" id="alamat_profil" type="text" class="form-control" value="" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                                <label>Desa</label>
                                <input name="desa_profil" id="desa_profil" type="text" class="form-control" value="" disabled>
                            </div>
                            <div class="form-group">
                                <label>Kecamatan</label>
                                <input name="kec_profil" id="kec_profil" type="text" class="form-control" value="" disabled>
                            </div>
                            <div class="form-group">
                                <label>Kabupaten</label>
                                <input name="kab_profil" id="kab_profil" type="text" class="form-control" value="" disabled>
                            </div>
                        </div> <!-- .col-sm-6 -->
                    </div>
                </div> <!-- .card Header -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <select name="no_rekening_bank" id="no_rekening_bank" class="form-control" required>
                                        <option value="">Pilih</option>
                                        @foreach ($ref_rekening as $item)
                                        <option value="{{ $item->no_rekening }}">{{ $item->no_rekening . ' - ('. $item->nama_rekening .')' }}</option>
                                        @endforeach
                                    </select>
                                </div>
...
<script>
    ...
    function initLoad() {
        ...
        $("#status_transaksi").attr('disabled', true);
        $("#no_rekening_bank").attr('readonly', true);
        $("#no_rekening_bank").attr('disabled', true);
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $("#no_rekening_bank").attr('disabled', false);
                $("#no_rekening_bank").val(res.no_rekening_bank);
                $("#tgl_setor").val(res.tgl_setor);
                $("#nama_penyetor").val(res.nama_penyetor);

                $("#status_transaksi").val(res.status_transaksi);
                $("#kode_ppat").val(res.kode_ppat);
    ...
    function modeEdit() {
        swal({
            ...
            if (confirm) {
                ...
                $("#no_rekening_bank").attr('readonly', false);

                var component = "<div class='col-md-8'></div>";
                component += "<div class='col-md-2'>";
                component += "<button type='submit' class='btn btn-block bg-indigo'>";
                component += "<i class='fas fa-save mr-2'></i> Simpan";
                component += "</button>";
                component += "</div>";
                component += "<div class='col-md-2'>";
    ...
    $('body').on('click', '.cetak', function(event) {
        ...
        console.log(url);
        swal({
            title: "Yakin cetak transaksi peralihan BPHTB?",
            text: "Hasil cetak berupa Pdf",
            icon: "warning",
            buttons: true
        }).then((willEdit) => {
            if (willEdit) {
    ...
    function hapus() {
        swal({
            ...
            if (willDelete) {
                ...
                $.ajax({
                    url: "{{ url('') }}/transaksi/peralihan/hapus/" + idPeralihan,
                    type: "POST",
                    data: {
                        '_method': 'DELETE'
                    },
                    ...
                    success: function(data) {
                        ...
                        if (data.result) {
                            ...
                            window.location = "{{ url('') }}/transaksi/peralihan";
                        } else {
