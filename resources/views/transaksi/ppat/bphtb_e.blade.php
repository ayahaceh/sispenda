        ...
        <div class="col-12">
            <div class="card card-default card-outline">
                <div class="text-indigo">
                    <form action="{{ route('ppat.bphtb.update', ['id' => $data->id]) }}" method="post"
                        ...
                        <div class="card-header bg-indigo">
                            ...
                            <div class="card-tools">
                                <ul class="pagination pagination-sm">
                                    <li class="page-item">
                                        <a href="{{ route('ppat.bphtb.show', ['id' => $data->id]) }}"
                                            class="page-link text-indigo">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nik_mask" id="nik_mask"
                                                    ...
                                                    inputmode="numeric" value="{{ $data->format_nik }}" required
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" name="nop_mask" id="nop_mask" class="form-control"
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label for="berkas_ktp" class="col-sm-4 col-form-label">Berkas
                                    KTP</label>
                                <div class="col-sm-8">
                                    <img id="preview_img_ktp" src="{{ $data->file_ktp }}"
