    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-default">
                <form action="{{ route('transaksi.peralihan.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img id="preview_img" src="{{ asset('/upload/users/comp/default.jpg') }}"
                                            style="margin-bottom: 15px" class="" width="160" height="160" />
                                    </div>
                                    <div class="col-sm-9">
                                        <div class="form-group">
                                            <label for="profil_id">Pilih Wajib Pajak</label>
                                            <select id="profil_id" name="profil_id" onchange="UpdateProfil()"
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <input name="desa_profil" id="desa_profil" type="text" class="form-control" value=""
                                        disabled>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4">Kecamatan</label>
                                    <input name="kec_profil" id="kec_profil" type="text" class="form-control" value=""
                                        disabled>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-4">Kabupaten</label>
                                    <input name="kab_profil" id="kab_profil" type="text" class="form-control" value=""
                                        disabled>
                                </div>
                            </div> <!-- .col-sm-6 -->
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select id="nop" name="nop" class="form-control" onchange="changeNop()" required>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="letak_nop" type="text" id="letak_nop" class="form-control" value=""
                                            placeholder="Letak Lokasi Tanah / Bangunan" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="desa_nop" class="col-sm-4 col-form-label">Desa</label>
                                    <div class="col-sm-8">
                                        <input name="desa_nop" type="text" id="desa_nop" class="form-control" value=""
                                            placeholder="Desa" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="rtrw_nop" class="col-sm-4 col-form-label">RT / RW </label>
                                    <div class="col-sm-8">
                                        <input name="rtrw_nop" type="text" id="rtrw_nop" class="form-control" value=""
                                            placeholder="RT / RW ..." disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="kec_nop" class="col-sm-4 col-form-label">Kecamatan</label>
                                    <div class="col-sm-8">
                                        <input name="kec_nop" type="text" id="kec_nop" class="form-control" value=""
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="kab_nop" type="text" id="kab_nop" class="form-control" value=""
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="kode_jenis_perolehan" type="text" id="kode_jenis_perolehan"
                                            class="form-control" value="" placeholder="Desa" disabled>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input name="no_sertifikat" type="text" id="no_sertifikat" class="form-control"
                                            value="" placeholder="Nomor Sertifikat..." disabled>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input name="luas_tanah" type="text" id="luas_tanah"
                                                class="form-control decimal" value="" placeholder="Luas Tanah" disabled>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <input name="luas_bangunan" type="text" id="luas_bangunan"
                                                class="form-control decimal" value="" placeholder="Luas Bangunan" disabled>
                                            <div class="input-group-append">
                                                <span class="input-group-text">M<sup>2</sup></span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input name="njop_tanah" type="text" id="njop_tanah"
                                                class="form-control integer" value="" placeholder="NJOP Bangunan" disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input name="njop_pbb" type="text" id="njop_pbb" class="form-control integer"
                                                value="" placeholder="NJOP PBB" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            ...
                                            <input name="hak_nilai_pasar" type="text" id="hak_nilai_pasar"
                                                class="form-control integer" value=""
                                                placeholder="Hak Transaksi / Nilai Pasar" disabled>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="npop" type="text" id="npop" class="form-control integer" value=""
                                            placeholder="NPOP" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="npoptkp" type="text" id="npoptkp" class="form-control integer"
                                            value="" placeholder="NPOPTKP" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="npopkp" type="text" id="npopkp" class="form-control integer" value=""
                                            placeholder="NPOPKP" readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="jumlah" class="col-form-label">Bea Perolehan Hak atas Tanah dan Bangunan
                                        yang terutang
                                        <br /><small><i>Memperhatikan nilai pada NJOP dan Nilai Transaksi/Nilai
                                                Pasar.</i></small>
                                    </label>
                                    <div class="input-group">
                                        ...
                                        <input name="jumlah" type="text" id="jumlah" class="form-control integer" value=""
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label for="opsi_b" class="custom-control-label">B. STPD BPHTB / SKPD Kurang Bayar
                                            / SKPDB Kurang Bayar Tambahan.</label>
                                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="jumlah_setor" type="text" autocomplete="off" id="jumlah_setor"
                                            ...
                                            value="{{ old('jumlah_setor') }}" placeholder="Jumlah yang disetor">
                                    </div>
                                    @error('jumlah_setor')
                                    ...
                                    <div class="input-group">
                                        <select name="no_rekening_bank" id="no_rekening_bank" class="form-control"
                                            ...
                                            @foreach ($ref_rekening as $item)
                                                <option value="{{ $item->no_rekening }}">{{ $item->no_rekening }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="tgl_setor" type="date" id="tgl_setor"
                                            class="form-control @error('tgl_setor') is-invalid @enderror"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nama_penyetor" type="text" id="nama_penyetor" autocomplete="off"
                                        ...
                                        value="{{ old('nama_penyetor') }}" placeholder="Nama Penyetor">
                                    @error('nama_penyetor')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_transaksi" id="status_transaksi" class="form-control"
                                        aria-placeholder="Status Transaksi" required>
                                        <!-- <option value=""></option> -->
                                        <option value="{{ STATUS_TRANSAKSI_LUNAS }}">{{ STATUS_TRANSAKSI_LUNAS }}
                                        </option>
                                        <option value="{{ STATUS_TRANSAKSI_BELUM_LUNAS }}">
                                            {{ STATUS_TRANSAKSI_BELUM_LUNAS }}</option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="tgl_peralihan" type="date" id="tgl_peralihan" autocomplete="off"
                                        class="form-control @error('tgl_peralihan') is-invalid @enderror"
                                        value="{{ old('tgl_peralihan') }}" required>
                                    @error('tgl_peralihan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
...
@section('script')
    ...
    <script>
        ...
        function setAutoNumeric() {
            ...
            [njopTanah, njopBangunan, njopPBB, nilaiPasar, npop, npoptkp, npopkp, jumlah, jumlahSetor] = new AutoNumeric
                .multiple('.integer', {
                    currencySymbol: '',
                    decimalCharacter: ',',
        ...
        $('#profil_id').select2({
            placeholder: 'Ketik nama atau NIK Wajib Pajak)',
            // width: null,
            width: 'resolve',
        ...
        $('#nop').select2({
            placeholder: 'Ketik NOP atau NIK atau NAMA',
            // width: null,
            width: 'resolve',
            ...
            if (no_nop != '' && no_nop != null) {
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $("#no_b").val(res.no_urut);
                    }
                });
            }
        }

        // BAGIAN INI UNTUK MENGISI FORMULIR BAGIAN C
        // MASIH BELUM BERHASIL PARSING DATA JSON DARI CONTROLLER
        function UpdateTarifBphtb() {
            let no_nop = $("#nop").val()
            if (no_nop != '' && no_nop != null) {
                $.ajax({
                    url: "{{ url('') }}/nop/pbb/tarif/",
                    success: function(res) {
                        $.each(res, function(index, element) {
                            console.log(res)
                            $("#npoptkp").val(element.tarif_npop_tkp);

                            // Tentukan nilai NPOP (Ambil nilai terbesar)
                            let NilaiPasar = $("#hak_nilai_pasar").val()
                            let NjopPbb = $("#njop_pbb").val(NjopPbb);

                            if (NilaiPasar > NjopPbb) {
                                $("#npop").val(NilaiPasar);
                            } else {
                                $("#npop").val(NjopPbb);
                            }
                            let jumlahNpop = $("#npop").val()

                            // Tentukan dapat npoptkp 60 jt atau tidak
                            JumlahNpoptkp = element.tarif_npop_tkp
                            jumlahNpopkp = jumlahNpop - JumlahNpoptkp
                            persenTarif = element.persen_tarif_pbb
                            jumlahTerutang = jumlahNpopkp * element.persen_tarif_pbb
                            // Tampilkan Angka
                            $("#npopkp").val(jumlahNpopkp);
                            $("#jumlah_terutang").val(jumlahTerutang);
