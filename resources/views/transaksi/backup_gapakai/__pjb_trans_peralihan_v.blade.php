...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-default">
            <form action="{{ route('ppat.peralihan',$data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-header bg-indigo">
                    ...
                    <div class="card-tools">
                        <ul class="pagination pagination-sm">
                            ...
                            <li class="page-item">
                                <a href="{{ route('transaksi.peralihan.laporan',$data->id) }}" class="page-link text-indigo">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input name="tgl_setor" type="text" value="{{ date('j F Y', strtotime($data->tgl_pelunasan)) }}" id="tgl_setor" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="nama_penyetor" class="col-form-label">Nama Penyetor</label>
                                <input name="nama_penyetor" type="text" id="nama_penyetor" autocomplete="off" class="form-control" value="@isset($data->nama_penyetor) {{ $data->nama_penyetor }}@endisset" placeholder="Nama Penyetor" readonly>
                            </div>
                            <div class="form-group">
                                <label for="status_transaksi" class="col-form-label">Status Transaksi</label>
                                <select name="status_transaksi" id="status_transaksi" class="form-control" aria-placeholder="Status Transaksi" readonly>
                                    <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <input name="tgl_peralihan" type="text" id="tgl_peralihan" value="{{ date('j F Y', strtotime($data->tgl_peralihan)) }}" autocomplete="off" class="form-control" readonly>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input name="status_transaksi" id="status_transaksi" type="text" class="form-control col-sm-8 bg-danger" value="{{$data->status_transaksi  . ' ['. date('d-M-y', strtotime($data->tgl_setor)) .']'}}" disabled>
                            </div>
                            @else
                            <div class="form-group row">
                                <label class="col-sm-4 text-success">Status Transaksi</label>
                                <input name="status_transaksi" id="status_transaksi" type="text" class="form-control col-sm-8 bg-success" value="{{$data->status_transaksi  . ' ['. date('d-M-y', strtotime($data->tgl_setor)) . ']'}}" disabled>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
        setAutoNumeric();
        $("#tgl_setor").val("{{ date('j F Y', strtotime($data->tgl_setor)) }}");
        $("#tgl_peralihan").val("{{ date('j F Y', strtotime($data->tgl_peralihan)) }}");
    });
    ...
    function save() {
        ...
        var url = "{{ route('ppat.peralihan.update_bukti_pembayaran', $data->id) }}";
